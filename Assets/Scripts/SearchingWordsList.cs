...
public class SearchingWordsList : MonoBehaviour
{
    ...
    {
        do // Dit voorkomt dat er niet meer Rows worden aangemaakt dan de ingestelde maximale Rows in de inspector.
        {
            _columns++;
    ...
    private Vector2 GetFirstSquarePosition()
    {
        ...
        // Als we al onze letters hebben dan moeten we ze ook in het center plaatsen.
